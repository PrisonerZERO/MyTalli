	...
	private void ReadQueryStringMessages()
	{
		...
		if (query.TryGetValue("error", out var error))
			ErrorMessage = error.ToString() switch
			{
				...
				"stripe_denied" => "You cancelled the connection to Stripe. No data was saved.",
				"stripe_invalid" => "Stripe returned an invalid response. Please try again.",
				...
				"stripe_state" => "Connection could not be verified. Please try again.",
