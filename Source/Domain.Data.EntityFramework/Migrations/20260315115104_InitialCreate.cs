...
public partial class InitialCreate : DbMigrationBase
{
    ...
    protected override void UpTables(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_UserAuthApple", x => x.UserId);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_UserAuthGoogle", x => x.UserId);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_UserAuthMicrosoft", x => x.UserId);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_BillingStripe", x => x.BillingId);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_SubscriptionStripe", x => x.SubscriptionId);
                table.ForeignKey(
