...
public class PayoutConfiguration : IEntityTypeConfiguration<Payout>
{
	...
	public void Configure(EntityTypeBuilder<Payout> builder)
	{
		...
		builder.Property(e => e.ExpectedArrivalDate).HasColumnOrder(4);
		builder.Property(e => e.PayoutDate).HasColumnOrder(5);
		builder.Property(e => e.Platform).HasMaxLength(50).IsRequired().HasColumnOrder(6);
		builder.Property(e => e.PlatformPayoutId).HasMaxLength(255).IsRequired().HasColumnOrder(7);
