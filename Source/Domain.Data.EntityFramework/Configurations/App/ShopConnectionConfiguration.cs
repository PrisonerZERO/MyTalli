...
public class ShopConnectionConfiguration : IEntityTypeConfiguration<ShopConnection>
{
	...
	public void Configure(EntityTypeBuilder<ShopConnection> builder)
	{
		...
		builder.Property(e => e.ConsecutiveFailures).HasDefaultValue(0).HasColumnOrder(3);
		builder.Property(e => e.IsActive).HasDefaultValue(true).HasColumnOrder(4);
		builder.Property(e => e.IsEnabled).HasDefaultValue(true).HasColumnOrder(5);
		builder.Property(e => e.LastErrorMessage).HasMaxLength(2000).HasColumnOrder(6);
		builder.Property(e => e.LastSyncDateTime).HasColumnOrder(7);
		builder.Property(e => e.NextSyncDateTime).HasColumnOrder(8);
		builder.Property(e => e.PlatformShopId).HasMaxLength(255).IsRequired().HasColumnOrder(9);
		builder.Property(e => e.ShopName).HasMaxLength(255).IsRequired().HasColumnOrder(10);
		builder.Property(e => e.Status).HasMaxLength(20).IsRequired().HasColumnOrder(11);
